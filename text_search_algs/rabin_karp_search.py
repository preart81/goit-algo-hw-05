...
def rabin_karp_search(main_string, substring) -> int:
    """
    ...
    ----------
    main_string: str
        текст, в якому виконується пошук
    substring: str
        підрядок, який шукається в тексті

    Результат:
    ----------
    Індекс початку підрядка в тексті, якщо підрядок знадено, інакше -1
    """
