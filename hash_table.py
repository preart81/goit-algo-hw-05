class HashTable:
    ...
    def hash_function(self, key):
        ...
        Він використовує вбудовану функцію hash Python, щоб отримати хеш ключа,
    ...
    def insert(self, key, value):
        ...
        таблиці такий ключ. Якщо так, то вона оновлює значення. Якщо ні, то вона
        додає нову пару ключ-значення до відповідного ланцюга."""
